<?php
/**
 * SoSimple Magazine functions and definitions.
 *
...
define( 'THEME_SLUG', 'sosimple_magazine' );
...
function theme_setup() {
	 ...
	 * If you're building a theme based on SoSimple Magazine, use a find and replace
...
function theme_scripts() {
	wp_enqueue_style( 'sosimple-magazine-style', get_stylesheet_uri() );

	wp_enqueue_script( 'sosimple-magazine-navigation', get_template_directory_uri() . '/js/navigation.js', array(), '20151215', true );

	wp_enqueue_script( 'sosimple-magazine-skip-link-focus-fix', get_template_directory_uri() . '/js/skip-link-focus-fix.js', array(), '20151215', true );
